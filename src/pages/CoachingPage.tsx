        ...
        <Container>
          <div ref={ref as React.RefObject<HTMLDivElement>} className="space-y-6">
            ...
            {products.map((p, i) => (
              ...
              >
                <Link to={`/coaching/${p.slug}`} className="grid gap-8 p-8 md:grid-cols-12 md:p-12">
                  <div className="md:col-span-4">
                    <div className="text-eyebrow uppercase font-mono text-coral-500 mb-3">
                  ...
                  <div className="md:col-span-3 flex md:items-end md:justify-end">
                    <div className="inline-flex items-center gap-3 rounded-full border border-ink/15 px-5 py-3 text-sm font-medium transition-all duration-500 group-hover:bg-ink group-hover:text-bone-50 group-hover:border-ink">
                      {t("coaching.apply")}
