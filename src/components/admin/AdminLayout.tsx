...
import { Box, FolderOpen, FileText, LogOut, Sparkles, CalendarDays, Wallet, Download, Mail, MailOpen, Newspaper, Award } from "lucide-react";
...
const NAV = [
  ...
  { to: "/admin/import", label: "Import from Shopify", icon: Download },
];
